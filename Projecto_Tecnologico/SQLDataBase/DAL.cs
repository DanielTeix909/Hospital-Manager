...
namespace DataAccessLayer
{
    public class DAL
    {
        ...
        public DAL()
        {
            _SqlConn = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=D:\\GOOGLE DRIVE\\TRABALHOS DE ESCOLA\\TRABALHO DE ESCOLA 2º ANO\\PROJECTO TECNOLOGICO\\DROPBOX\\DANIEL\\DATABASE\\H_MANAGER.MDF;Integrated Security=True;Connect Timeout=30");
        }
