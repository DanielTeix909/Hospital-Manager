...
{
    public partial class E_Configurações : Form
    {
        int move;
        int moveX;
        int moveY;
        ...
        private object lb_forca;

        public E_Configurações()
        {
            InitializeComponent();
        }
        ...
        private void E_Configurações_Load(object sender, EventArgs e)
        {
        ...
        private void UpdateProgressBar()
        {
            ...
            label_forca.Text = string.Format(PASS_STRENGTH_FORMAT, strength, PASS_MAX);
        ...
        {
            this.Hide();
            ((Gestor_Enfermeiros)this.MdiParent).pn_configuraçoes.Show();
        }

        private void b_close_Click(object sender, EventArgs e)
        {
            ((Gestor_Enfermeiros)this.MdiParent).E_Configurações.Enabled = true;
            this.Close();
        }
