...
{
    public partial class M_Receitas : Form
    {
        int move;
        int moveX;
        int moveY;
        ...
        {
            this.Hide();
            ((Gestor_Médicos)this.MdiParent).pn_receitas.Show();
        }

        private void b_close_Click(object sender, EventArgs e)
        {
            ((Gestor_Médicos)this.MdiParent).M_Receitas.Enabled = true;
            this.Close();
        }
        ...
        {
            int regreceita = BLL.receitas.updatereceitas(tb_medicamento.Text, tb_ref_utente.Text, tb_medico.Text, tb_utentes.Text, tb_medico.Text, cb_categoria.Text, tb_taxa.Text, tb_ref_receita.Text, tb_obers.Text, dtp_emissao.Value, dtp_validade.Value);
            tb_medicamento.Clear();
            tb_ref_utente.Clear();
            tb_medico.Clear();
            tb_utentes.Clear();
