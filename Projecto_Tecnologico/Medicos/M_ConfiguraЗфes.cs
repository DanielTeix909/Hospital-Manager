...
{
    public partial class M_Configurações : Form
    {
        int move;
        int moveX;
        int moveY;
        ...
        private void M_Configurações_Load(object sender, EventArgs e)
        {
        ...
        {
            this.Hide();
            ((Gestor_Médicos)this.MdiParent).pn_configuraçoes.Show();
        }
        ...
        {
            ((Gestor_Médicos)this.MdiParent).M_Configurações.Enabled = true;
            this.Close();
        }
